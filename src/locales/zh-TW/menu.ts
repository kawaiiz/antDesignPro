export default {
  'menu.authentication-index': '認證管道清單',
  'menu.authentication': '認證管道管理',
  'menu.channel-index': '頻道清單',
  'menu.channel': '頻道管理',
  'menu.column-index': '欄目清單',
  'menu.column': '欄目管理',
  'menu.client-index': '前端用戶清單',
  'menu.client': '前端用戶管理',
  'menu.page-index': '頁面清單',
  'menu.page': '頁面管理',
  'menu.authority-auth': '權限設置',  
  'menu.authority-person': '人員設定',
  'menu.authority-role': '角色設定',
  'menu.authority-resources': '權限資源',
  'menu.authority': '权限',
  'menu.route': '路由',
  'menu.welcome': '歡迎',
