export default {
  ...
  'account-settings.reset-password.oldPassword-message': '请输入当前密码',
  'account-settings.reset-password.newPassword': '新密码',
  'account-settings.reset-password.newPassword-message': '请输入新密码',
