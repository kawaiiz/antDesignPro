export default {
  ...
  'account-settings.menuMap.reset-password': '修改密碼',
  'account-settings.menuMap.binding': '賬號綁定',
  'account-settings.menuMap.notification': '新消息通知',
  'account-settings.reset-password.oldPassword': '當前密碼',
  'account-settings.reset-password.oldPassword-message': '請輸入當前密碼', 'account-settings.reset-password.newPassword': '新密碼',
  ...
  'account-settings.basic.phone-message2': '請注意電話格式!',
  'account-settings.basic.captcha': '驗證碼',
  'account-settings.basic.captcha-message': '請輸入驗證碼!',
  'account-settings.basic.captcha-get': '獲取驗證碼',
