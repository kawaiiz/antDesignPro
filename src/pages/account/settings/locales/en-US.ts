export default {
  ...
  'account-settings.menuMap.reset-password': 'Reset password',
  'account-settings.menuMap.binding': 'Account Binding',
  'account-settings.menuMap.notification': 'New Message Notification',
  'account-settings.reset-password.oldPassword': 'Current password',
  'account-settings.reset-password.oldPassword-message': 'Please input current password',
  'account-settings.reset-password.newPassword': 'New password',
  'account-settings.reset-password.newPassword-message': 'Please input new password',
